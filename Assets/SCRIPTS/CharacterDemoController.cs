...
{
	Animator animator;
	public GameObject floorPlane1;//in this demonstration this is set manually, the Retail Ability system has methods for dealing with this automatically via data structures for environments
    public GameObject floorPlane2;
    public GameObject floorPlane3;
    public GameObject floorPlane4;
    public GameObject floorPlane5;
    public GameObject floorPlane6;
	...
	float				rotateSpeed = 2.0f; //used to smooth out turning
	...
	void Update () 
	{
       ...
       //if(floorPlane1.GetComponent<Collider>().Raycast(ray, out hit, 500.0f)||floorPlane2.GetComponent<Collider>().Raycast(ray, out hit, 500.0f)||floorPlane3.GetComponent<Collider>().Raycast(ray, out hit, 500.0f)||floorPlane4.GetComponent<Collider>().Raycast(ray, out hit, 500.0f)||floorPlane5.GetComponent<Collider>().Raycast(ray, out hit, 500.0f)|| floorPlane6.GetComponent<Collider>().Raycast(ray, out hit, 500.0f)) //check to see if that ray hits our "floor"												
       //{
